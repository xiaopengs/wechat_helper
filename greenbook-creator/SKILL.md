...
- **生成工具**：[`scripts/gen_media.sh`](scripts/gen_media.sh)（统一入口：图像/视频/编辑/多模型）
  ...
  - 风格预设 `default`（浅色知识漫画）| `tech-dark`（深色科技风）| `tech-light`（浅色架构风）| **`cartographer`（米黄+黑+黄知识图解，2026-06-19 新增）** | **`orange-parenting`（暖橘治愈亲子风，2026-06-25 新增）** | **`skill-review`（工程师视角项目速查，2026-06-29 新增）** — 在 `scripts/styles/` 下增删 `.txt` 即可
...
- **情感共鸣向专题**：[references/style-orange-parenting.md](references/style-orange-parenting.md) — 暖橘治愈亲子风 / 5 页标准结构 / 育儿/情绪/关系/成长主题（2026-06-25 新增）
...
- 风格预设：[scripts/styles/](scripts/styles/) — `default.txt`（知识漫画）/ `tech-dark.txt` / `tech-light.txt` / **`cartographer.txt`（米黄+黑+黄知识图解，2026-06-19 新增）** / **`orange-parenting.txt`（暖橘治愈亲子风，2026-06-25 新增）** / **`skill-review.txt`（工程师视角项目/技能速查，2026-06-29 新增）**
